...
class MyWorker(context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
    companion object {
        ...
        //const val APP_ID = "705be58e7a2c673b27419e745ed23194"
    ...
    private fun getCurrentWeather(city: String?): Result {
        ...
        val url = "https://api.openweathermap.org/data/2.5/weather?q=$city&appid=${com.dicoding.myworkmanager.BuildConfig.API_KEY}"
