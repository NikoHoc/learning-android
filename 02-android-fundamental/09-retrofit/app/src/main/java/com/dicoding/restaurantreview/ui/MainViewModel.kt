...
//    val listReview: LiveData<List<CustomerReviewsItem>> = _listReview
    ...
    //cara lain Enkapsulasi  data -> backing property
    val listReview = MutableLiveData<List<CustomerReviewsItem>>()
        ...
        client.enqueue(object : retrofit2.Callback<RestaurantResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    listReview.value = response.body()?.restaurant?.customerReviews
                } else {
